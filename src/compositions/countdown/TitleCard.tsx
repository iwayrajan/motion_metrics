  ...
  return (
    <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", opacity }}>
      <div style={{ transform: `scale(${scale})`, textAlign: "center", padding: "0 60px" }}>
        <div style={{ fontFamily: "'Inter'", fontWeight: 800, fontSize: 56, color: TEXT_COLOR }}>{title}</div>
        <div style={{ fontFamily: "'Inter'", fontWeight: 600, fontSize: 26, color: "#7C5CFC", marginTop: 8 }}>
          {subtitle}
        </div>
      </div>
    </AbsoluteFill>
